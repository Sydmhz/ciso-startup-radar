...
export const metadata: Metadata = {
  ...
  description:
    "Pricing plans for cybersecurity founders. Launch your startup on CISOStartupRadar and connect with verified CISOs.",
};
...
const comparisonFeatures = [
  { name: "Startup Directory Access", founders: true, featured: true },
  { name: "Company Profile Page", founders: true, featured: true },
  { name: "Analytics Dashboard", founders: true, featured: true },
  { name: "Venture Network", founders: false, featured: true },
  { name: "Featured Listing", founders: false, featured: true },
  { name: "Unlimited CISO Outreach", founders: false, featured: true },
  { name: "Priority Support", founders: false, featured: true },
  { name: "Dedicated Account Manager", founders: false, featured: true },
];
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-white leading-tight">
            Launch your cybersecurity
            <br />
            startup on our platform
          </h1>
          <p className="text-white/50 mt-4 text-lg max-w-xl mx-auto leading-relaxed">
            Get in front of verified CISOs, build partnerships, and accelerate your go-to-market.
          </p>
          <div className="mt-6">
            <Link
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                        tier.dark ? "bg-white/10" : "bg-[#1E3A5F]/5"
                      }`}
                    >
                      <Icon
                        className={`h-5 w-5 ${
                      ...
                      <li key={feature} className="flex items-start gap-2.5">
                        <div
                          className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${
                            tier.dark ? "bg-[#0057FF]/20" : "bg-green-50"
                          }`}
                        >
                          <Check
                            className={`h-2.5 w-2.5 ${
                              tier.dark ? "text-[#0057FF]" : "text-green-600"
                            }`}
                            strokeWidth={3}
                          />
                        </div>
              ...
              <tbody>
                {comparisonFeatures.map((feature, idx) => (
                  ...
                  >
                    ...
                    {([feature.founders, feature.featured] as boolean[]).map(
                      (val, i) => (
      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-2xl md:text-3xl text-white mb-3">
            Ready to get in front of CISOs?
          </h2>
          <p className="text-white/50 mb-8 max-w-lg mx-auto">
            Join hundreds of cybersecurity founders already building relationships with security leaders.
          </p>
